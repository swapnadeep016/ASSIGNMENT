<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="match3.aspx.cs" Inherits="BOOKING_APPLICATION.match3" %>
...
<body>
    <form id="form1" runat="server">
         ...
         <table>
            <tr>
                <td>
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/pic/rugby-stedium-3.jpg" Height="400px" Width="100%" />
                </td>             
            </tr>
         </table>
